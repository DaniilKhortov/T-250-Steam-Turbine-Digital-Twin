...
loadObjWithMaterials(
    '/models/TurbineT250Full/turbineTextured.obj',
    '/models/TurbineT250Full/turbineTextured.mtl'
);
...
function loadObjWithMaterials(objPath, mtlPath) {
    mtlLoader.load(
        mtlPath,
        (materials) => {
            materials.preload(); // Підготовка матеріалів
            objLoader.setMaterials(materials); // Додаємо матеріали до завантажувача OBJ
...
document.getElementById('loadNewModel').addEventListener('click', () => {
    loadObjWithMaterials(
        '/models/TurbineT250/Schema.obj',
        '/models/TurbineT250/Schema.mtl'
    );
});
...
function resetScene() {
    ...
    loadObjWithMaterials(
        '/models/TurbineT250Full/turbine5United.obj',
        '/models/TurbineT250Full/turbine5United.mtl'
    );
...
// loadObj('/models/TurbineT250Full/turbineTextured.obj');
...
// // Додаємо обробник подій для кнопки
// document.getElementById('loadNewModel').addEventListener('click', () => {
//     loadObj('/models/TurbineT250/Schema.obj'); // Задайте шлях до нової моделі
// });
// document.getElementById('reset-btn').addEventListener('click', () => {
